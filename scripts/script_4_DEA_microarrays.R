...
DEA_microarrays <- function(Exprs_table, Pheno_data_table,sample_type_colname, diff_exp_type,adjust_pvalue_method="BH", LogFC_cuttoff=NULL, Adj_p_value_cuttoff=NULL,  annotation_microarray_probesets=FALSE,   outputFileFolder ){
...
if(annotation_microarray_probesets){ 
 ...
 library(annotate)
TOPTABLE$gene.symbols <- getSYMBOL(row.names(TOPTABLE), "hgu133plus2")
